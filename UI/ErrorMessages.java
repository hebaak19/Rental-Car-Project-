...
public class ErrorMessages {
    ...
    public static final String INVALID_PHONE_NUMBER = "Invalid phone number format. Phone number should contain exactly 10 digits.";
    ...
    public static final String CAR_NOT_AVAILABLE = "Car not available for rent.";
    public static final String NO_EMPLOYEES = "No employee found with the provided credentials. Access denied.";
    public static final String INVALID_CARD_NUMBER = "Invalid credit card number format. Card number should contain exactly 10 digits.";
    public static final String INVALID_CONTRACT_ID = "Invalid Contract ID format. ID should contain only digits and be at least 4 characters long.";
